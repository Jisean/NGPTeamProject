...
void CSoundMgr::LoadSoundFile()
{
	...
	handle = _findfirst("..\\Sound\\*.*", &fd);  //현재 폴더 내 모든 파일을 찾는다.       
	if (handle == -1)
	{ 
		return;
	}      
...
void CSoundMgr::Monster5Sound( TCHAR* szSoundKey )
{
	map<TCHAR*, FMOD_SOUND*>::iterator iter;
	iter =  find_if(m_mapSound.begin(), m_mapSound.end(), CStringCompare(szSoundKey));
...
void CSoundMgr::Monster6Sound( TCHAR* szSoundKey )
{
	map<TCHAR*, FMOD_SOUND*>::iterator iter;
	iter =  find_if(m_mapSound.begin(), m_mapSound.end(), CStringCompare(szSoundKey));
...
void CSoundMgr::EffectSound1( TCHAR* szSoundKey )
{
	map<TCHAR*, FMOD_SOUND*>::iterator iter;
	iter =  find_if(m_mapSound.begin(), m_mapSound.end(), CStringCompare(szSoundKey));
...
void CSoundMgr::EffectSound2( TCHAR* szSoundKey )
{
	map<TCHAR*, FMOD_SOUND*>::iterator iter;
	iter =  find_if(m_mapSound.begin(), m_mapSound.end(), CStringCompare(szSoundKey));
...
void CSoundMgr::EffectSound3( TCHAR* szSoundKey )
{
	map<TCHAR*, FMOD_SOUND*>::iterator iter;
	iter =  find_if(m_mapSound.begin(), m_mapSound.end(), CStringCompare(szSoundKey));
...
void CSoundMgr::EffectSound4( TCHAR* szSoundKey )
{
	map<TCHAR*, FMOD_SOUND*>::iterator iter;
	iter =  find_if(m_mapSound.begin(), m_mapSound.end(), CStringCompare(szSoundKey));
...
void CSoundMgr::EffectSound5( TCHAR* szSoundKey )
{
	map<TCHAR*, FMOD_SOUND*>::iterator iter;
	iter =  find_if(m_mapSound.begin(), m_mapSound.end(), CStringCompare(szSoundKey));
